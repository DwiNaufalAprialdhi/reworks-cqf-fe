      ...
      return (
            <>
                  <div className='w-max h-max relative overflow-hidden flex-shrink-0'>
                        ...
                        <button className='lg:py-2 py-1 px-2 rounded-full bg-transparent flex items-center justify-center font-normal lg:text-sm text-xs text-theme-secondary text-center peer-checked:bg-white border border-theme-ascent border-opacity-0 peer-checked:border-opacity-100 peer-checked:text-theme-ascent duration-300'>
                              {props.title}
                        </button>
                  </div>
            </>
