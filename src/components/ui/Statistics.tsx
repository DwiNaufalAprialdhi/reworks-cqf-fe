      ...
      return (
            <>
                  <div className='w-full col-span-1 flex flex-col lg:items-start lg:justify-start items-center justify-center'>
                        <Icon name={props.name} className='w-6 h-6 mb-2 text-theme-dark' />
                        <h2 className='font-medium lg:text-sm text-xs leading-[21px] text-theme-dark mb-1 text-center lg:text-start'>{props.title}</h2>
