...
export default function CardChoice(props: CardChoiceProps) {
      ...
      return (
            <>
                  <Link href={props.link} className="w-full bg-white rounded-[16px] overflow-hidden block border border-theme-gray_lg/40 shadow-md lg:hover:-translate-y-1 duration-300">
