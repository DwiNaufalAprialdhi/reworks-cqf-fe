...
export default function OrnamentHero() {
      ...
      return (
            <>
                  ...
                  <div data-aos="fade-down" className="absolute top-[390px] lg:top-[-0px] md:top-[170px] left-0 w-full md:h-max h-full z-[1]">
                  ...
                  <div data-aos="fade-down" className="absolute top-[390px] lg:top-[-0px] md:top-[170px] left-0 w-full md:h-max h-full z-[2]">
