...
export default function OrnamentHero() {
      ...
      return (
            <>
                  ...
                  <div data-aos="fade-down" className="absolute top-[500px] lg:top-[220px] md:top-[250px] left-0 w-full md:h-auto h-full z-[-2]">
                        <Image src="/assets/ornament/oe-01.svg" alt="Ornament" width={1500} height={834} className="w-full h-auto object-cover" />
                  </div>
                  <div data-aos="fade-down" className="absolute top-[500px] lg:top-[220px] md:top-[250px] left-0 w-full md:h-auto h-full z-[-3]">
                        <Image src="/assets/ornament/oe-02.svg" alt="Ornament" width={1500} height={834} className="w-full h-auto object-cover" />
                  </div>
                  <div data-aos="fade-down" className="absolute top-[500px] lg:top-[220px] md:top-[250px] left-0 w-full md:h-auto h-full z-[-1]">
