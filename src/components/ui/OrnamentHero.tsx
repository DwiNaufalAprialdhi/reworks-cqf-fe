...
export default function OrnamentHero() {
      ...
      return (
            <>
                  ...
                  <div data-aos="fade-down" className="absolute top-[390px] lg:top-[-90px] md:top-[170px] left-0 w-full md:h-max h-full z-[1]">
                        <Image src="/assets/ornament/oh-01.svg" alt="Ornament" width={1500} height={834} className="w-full h-max object-cover" />
                  </div>
                  <div data-aos="fade-down" className="absolute top-[390px] lg:top-[-60px] md:top-[170px] left-0 w-full md:h-max h-full z-[3]">
                        <Image src="/assets/ornament/oh-02.svg" alt="Ornament" width={1500} height={834} className="w-full h-max object-cover" />
                  </div>
                  <div data-aos="fade-down" className="absolute top-[390px] lg:top-[-60px] md:top-[170px] left-0 w-full md:h-max h-full z-[2]">
                        <Image src="/assets/ornament/oh-03.svg" alt="Ornament" width={1500} height={834} className="w-full h-max object-cover" />
                  </div>
                  <div data-aos="fade-down" className="absolute top-[390px] lg:top-[-60px] md:top-[170px] left-0 w-full md:h-max h-full z-[4]">
