                  ...
                  <main className='w-full h-auto overflow-x-hidden relative z-[7] lg:pb-[200px] pb-[50px] font-smooth'>
                        <section className='container_section_view grid lg:grid-cols-2 grid-cols-1 md:gap-[50px] gap-5'>
                              ...
                              <div className='w-full h-auto col-span-1 flex flex-col'>
                                    ...
                                    {/* CTA */}
                                    <Link href='#' className="w-max flex items-center justify-start gap-2 bg-theme-ascent hover:bg-opacity-85 duration-300 lg:py-[10px] py-2 lg:px-[14px] px-3 rounded-full md:mt-[35px] mt-5">
                                          <h2 className='font-semibold lg:text-base text-xs text-white'>
                                                Daftar Sekarang
                                          </h2>
