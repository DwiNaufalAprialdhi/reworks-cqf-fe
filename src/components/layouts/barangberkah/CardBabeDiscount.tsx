...
export default function CardBabeDiscount(props: Props) {
      return (
            <>
                  <Link href={props.link} className={`shadow-md border border-theme-gray_lg/30 block w-full h-max rounded-[8px] overflow-hidden group ${props.className}`}>
                        ...
                        {/* Text & Rating */}
                        <div className='w-full bg-white p-3 flex flex-col lg:gap-y-2 gap-y-2'>
                              ...
                              <div className='w-full flex flex-col gap-y-2'>
                                    <div className='w-full flex flex-col'>
                                          ...
                                          <div className="w-full flex items-center gap-x-2">
                                                <h2 className='font-medium lg:text-[10px] text-[8px] text-[#9B9B9B] line-through'>
                                                      {props.priceNormal}
                                                </h2>
                                                <h2 className="font-semibold lg:text-[10px] text-[8px] text-[#D82525]">
                                                      {props.discount}
                                                </h2>
                                          </div>
                                    </div>
