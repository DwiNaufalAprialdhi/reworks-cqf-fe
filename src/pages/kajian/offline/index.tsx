...
import ItemTicket from '@/components/layouts/kajian/ItemTicket'

// Data tiket
const tickets = [
      { id: 1, title: "Early Bird", amount: "Rp 250.000" },
      { id: 2, title: "VIP", amount: "Rp 450.000" },
];
...
export default function Index() {
      ...
      // State untuk menyimpan counter masing-masing tiket
      const [counters, setCounters] = useState(
            tickets.map(() => 0) // Inisialisasi semua counter ke 0
      );
      ...
      const handleDecrement = (index: number) => {
            setCounters((prevCounters) =>
                  prevCounters.map((count, i) => (i === index && count > 0 ? count - 1 : count))
            );
      };
                        ...
                        <div className={`w-full md:max-w-[480px] max-w-none md:min-w-[480px] min-w-min bg-transparent rounded-t-3xl mx-auto h-max bottom-0 absolute left-0 right-0`}>
                              ...
                              >
                                          ...
                                          <div className='w-full md:max-h-max max-h-[400px] overflow-y-auto flex flex-col scroll-bar-modal pb-[113px]'>
                                                <div className="flex flex-col gap-y-3 mb-4">
                                                      {tickets.map((ticket, index) => (
                                                            <ItemTicket key={ticket.id} title={ticket.title} amount={ticket.amount}>
                                                                  <div className="w-auto h-auto bg-theme-ascent rounded-[4px] p-2 grid grid-cols-3 items-center lg:gap-4 gap-3">
                                                                        {/* Button Minus */}
                                                                        <div
                                                                              className="w-full col-span-1 cursor-pointer"
                                                                              onClick={() => handleDecrement(index)}
                                                                        >
                                                                              <Icon name="minus" className="lg:w-4 lg:h-4 w-3 h-3 text-white" />
                                                                        </div>
                                                                        {/* Counter Display */}
                                                                        <h2 className="w-full col-span-1 text-center font-semibold text-white text-xs">
                                                                              {counters[index]}
                                                                        </h2>
                                                                        {/* Button Plus */}
                                                                        <div
                                                                        ...
                                                                        >
                                                                              <Icon name="plus" className="lg:w-4 lg:h-4 w-3 h-3 text-white" />
                                                                        </div>
                                                                  </div>
                                                            </ItemTicket>
                                                      ))}
                                    ...
                                    <TwoButton>
                                          ...
                                          <ButtonPrimaryMbv onClick={() => window.location.href = '/kajian/payment'} className="w-full col-span-6">
                                                Beli Tiket
                                          </ButtonPrimaryMbv>
                                    </TwoButton>
                              </motion.div>
