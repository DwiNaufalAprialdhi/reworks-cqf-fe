...
export default function Index() {
      ...
      return (
            <>
                  {/* Head */}
                  <Head>
                        <title>CINTA QURAN CALL GLOBAL - CINTA QURAN FOUNDATION</title>
                  </Head>
                              ...
                              <div className="w-full h-auto p-5 border border-theme-gray_lg rounded-[8px]">
                                    <form action="#" className='w-full flex flex-col gap-y-4'>
                                          ...
                                          <div className='w-full grid grid-cols-3 lg:gap-4 gap-2'>
                                                <div className='w-full col-span-1 flex items-center justify-center gap-2'>
                                                      <input type="checkbox" name='sample1' id='sample1' value="sample1" className='w-3 h-3 cursor-pointer' required />
                                                      <label htmlFor="sample1" className='font-normal lg:text-sm text-xs text-theme-secondary'>
                                                            Sample
                                                      </label>
                                                </div>
                                                <div className='w-full col-span-1 flex items-center justify-center gap-2'>
                                                      <input type="checkbox" name='sample2' id='sample2' value="sample2" className='w-3 h-3 cursor-pointer' required />
                                                      <label htmlFor="sample2" className='font-normal lg:text-sm text-xs text-theme-secondary'>
                                                            Sample
                                                      </label>
                                                </div>
                                                <div className='w-full col-span-1 flex items-center justify-center gap-2'>
                                                      <input type="checkbox" name='sample3' id='sample3' value="sample3" className='w-3 h-3 cursor-pointer' required />
                                                      <label htmlFor="sample3" className='font-normal lg:text-sm text-xs text-theme-secondary'>
                                                            Sample
                                                      </label>
                                                </div>
                                          </div>
                                          ...
                                          <div className='w-full grid grid-cols-3 lg:gap-4 gap-2'>
                                                <div className='w-full col-span-1 flex items-center justify-center gap-2'>
                                                      <input type="radio" name='sample' id='sample' value="sample" className='w-3 h-3 cursor-pointer' required />
                                                      <label htmlFor="sample" className='font-normal lg:text-sm text-xs text-theme-secondary'>
                                                            Sample
                                                      </label>
                                                </div>
                                                <div className='w-full col-span-1 flex items-center justify-center gap-2'>
